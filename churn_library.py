# library doc string
'''
Description: This module develops the provided in churn_notebook.ipynb.
This is the main file of the last technical project 'Predict customer Churn
with Clean Code' for the DevOps Engineering Nanodegree Program

Author: Omary Saleh Mgembe
...
def perform_feature_engineering(dataframe, response):
    ...
    # Features DataFrame
    x_value[keep_cols] = encoded_df[keep_cols]

    # Train and Test split
    x_train, x_test, y_train, y_test = train_test_split(
        x_value, feature_y, test_size=0.3, random_state=42)
